...
void _settingsSerialize(
  ...
  writer.writeBool(offsets[1], object.onboarding);
...
Settings _settingsDeserialize(
  ...
  object.onboarding = reader.readBoolOrNull(offsets[1]);
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> onboardingIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> onboardingEqualTo(
      bool? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'onboarding',
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByOnboarding() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onboarding', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByOnboardingDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByOnboarding() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onboarding', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByOnboardingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'onboarding', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByOnboarding() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, bool?, QQueryOperations> onboardingProperty() {
    return QueryBuilder.apply(this, (query) {
